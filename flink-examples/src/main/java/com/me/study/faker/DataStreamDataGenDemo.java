package com.me.study.faker;

import com.me.study.bean.OrderInfo;
    ...
    SingleOutputStreamOperator<OrderInfo> orderInfoDS =
      env.addSource(new DataGeneratorSource<>(new RandomGenerator<OrderInfo>() {
        ...
        public OrderInfo next() {
          return new OrderInfo(random.nextInt(1, 100000), random.nextLong(1, 1000000), random.nextUniform(1, 1000),

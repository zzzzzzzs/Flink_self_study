package com.me.study.tuning.demo;

import com.alibaba.fastjson.JSONObject;
import com.me.study.tuning.demo.function.NewMidRichMapFunc;
import com.me.study.tuning.demo.function.UvRichFilterFunction;
import com.me.study.tuning.source.MockSourceFunction;
...
//    checkpointConfig.setCheckpointStorage("hdfs://node1:8020/flink-tuning/ck");
    ...
    SingleOutputStreamOperator<JSONObject> jsonobjDS =
        env.addSource(new MockSourceFunction()).map(data -> JSONObject.parseObject(data));
    ...
    // 实时统计uv
    uvDS.map(r -> Tuple3.of("uv", r.getJSONObject("common").getString("mid"), 1L))

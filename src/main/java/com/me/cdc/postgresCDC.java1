 ...
 * @date 2021/11/8
 * 
 *       https://github.com/ypt/experiment-flink-cdc-connectors-postgres-datastream
 *
 *       TODO 用 alibaba 的 cdc
 * 
...
public class postgresCDC {
  public static void main(String[] args) throws Exception {
    ...
    SourceFunction<String> sourceFunction1 = PostgreSQLSource.<String>builder()
      ...
      // .slotName("flink1")
      .hostname("localhost").port(5432).database("postgres").schemaList("public").tableList("aaa")
      .username("postgres").password("111")
